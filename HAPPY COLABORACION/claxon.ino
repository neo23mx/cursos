...
if (incomingByte == '1') {
      Serial.println("Piiiiiiit piiiiit");
      tone(ZumbadorPin,800,200);
      
    }

    if (incomingByte == '2') {
      Serial.println("Piiiiiiit piiiiit");
      tone(ZumbadorPin,1000,200);
      
    }
    if (incomingByte == '3') {
      Serial.println("Piiiiiiit piiiiit");
      tone(ZumbadorPin,1500,200);
      
    }
   if (incomingByte == '4') {
      Serial.println("Piiiiiiit piiiiit");
      tone(ZumbadorPin,1700,200);
      
    }

    if (incomingByte == '5') {
      Serial.println("Piiiiiiit piiiiit");
      tone(ZumbadorPin,1900,200);
